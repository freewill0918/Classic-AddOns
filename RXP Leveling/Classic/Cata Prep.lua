...
step
+Welcome to the guide to collecting all the items that will either start a quest to be easily turned in or is required for one a quest to be turned in for some free experience.
step << Horde
#completewith next
.goto Dragonblight,14.21,49.82,100 >> Travel to Westwind Refugee Camp
step << Horde
