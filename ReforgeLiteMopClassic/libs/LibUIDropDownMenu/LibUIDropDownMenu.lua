...
local function creatre_DropDownList(name, parent)
	...
	f:SetScript("OnShow", function(self)
		...
		EventRegistry:TriggerEvent("UIDropDownMenu.Exibir", self);
	end)
...
info.tooltipWhileDisabled = [nil, 1] -- Exibir the tooltip, even when the button is disabled.
info.hasArrow = [nil, true]  --  Exibir the expand arrow for multilevel menus
...
info.hasColorSwatch = [nil, true]  --  Exibir color swatch or not, for color selection
info.r = [1 - 255]  --  Red color value of the color swatch
info.g = [1 - 255]  --  Green color value of the color swatch
info.b = [1 - 255]  --  Blue color value of the color swatch
info.colorCode = [STRING] -- "|cAARRGGBB" embedded hex value of the button text color. Only used when button is enabled
info.swatchFunc = [function()]  --  Function called by the color picker on color change
info.hasOpacity = [nil, 1]  --  Exibir the opacity slider on the colorpicker frame
...
info.tooltipOnButton = [nil, 1] -- Exibir the tooltip attached to the button instead of as a Newbie tooltip.
