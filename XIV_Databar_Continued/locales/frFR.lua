...
L["SHOW_PROFESSIONS_BUTTON"] = "Afficher le bouton " .. (PROFESSIONS_BUTTON or "Professions")
...
L["SHOW_WARBAND_BANK_GOLD"] = "Afficher l'or de la " .. (ACCOUNT_BANK_PANEL_TITLE or "Banque de bande de guerre")
...
-- Reputation
L["OPEN_REPUTATION"] = "Ouvrir l'interface de " .. (REPUTATION or "Réputation")
