...
L["SHOW_PROFESSIONS_BUTTON"] = "Zeigt " .. (PROFESSIONS_BUTTON or "Berufe") .. " Taste"
...
-- Reputation
L["OPEN_REPUTATION"] = "Öffne " .. (REPUTATION or "Ruf")
...
-- Vault Module
L["GREAT_VAULT_DISABLED"] = "Das " .. (DELVES_GREAT_VAULT_LABEL or "Große Schatzkammer") .. " ist derzeit bis zum Beginn der nächsten Saison deaktiviert."
