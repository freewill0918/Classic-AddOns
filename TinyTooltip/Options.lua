...
frameStatusbar.anchor:SetSize(600, 1)
...
frameSpell.anchor:SetSize(600, 1)
...
frameFont.anchor:SetSize(600, 1)
...
frameVariables.anchor:SetSize(600, 1)
...
local categoryPC = Settings.RegisterCanvasLayoutCategory(framePCScrollFrame, " - Player")
categoryPC.parent = category.ID

local categoryNPC = Settings.RegisterCanvasLayoutCategory(frameNPCScrollFrame, " - NPC")
categoryNPC.parent = category.ID

local categoryStatusbar = Settings.RegisterCanvasLayoutCategory(frameStatusbar, " - StatusBar")
categoryStatusbar.parent = category.ID

local categorySpell = Settings.RegisterCanvasLayoutCategory(frameSpell, " - Spell")
categorySpell.parent = category.ID

local categoryFont = Settings.RegisterCanvasLayoutCategory(frameFont, " - Font")
categoryFont.parent = category.ID

local categoryVariables = Settings.RegisterCanvasLayoutCategory(frameVariables, " - Variables")
categoryVariables.parent = category.ID
