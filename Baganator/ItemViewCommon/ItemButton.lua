              ...
              if not queued then
                local function queueFunc()
                  ...
                  if itemButton.BGR == BGR and itemButton:IsShown() then
                    ...
                    if itemButton.BGR.guid and itemButton.BGR.itemLocation and itemButton.BGR.itemLocation.bagID and itemButton.BGR.itemLocation.slotIndex and C_Item.DoesItemExist(itemButton.BGR.itemLocation) and itemButton.BGR.guid ~= C_Item.GetItemGUID(itemButton.BGR.itemLocation) then
