...
ZygorGuidesViewer:RegisterInclude("SSO_PreQuest_Dailies",[[
	...
	step
		kill 6 Dawnblade Summoner##24978 |q 11540/1 |goto Isle of Quel'Danas 42.1,35.7
		kill 6 Dawnblade Blood Knight##24976 |q 11540/2 |goto Isle of Quel'Danas 42.1,35.7
		kill 3 Dawnblade Marksman##24979 |q 11540/3 |goto Isle of Quel'Danas 42.1,35.7
	...
	step
		...
		kill 6 Burning Legion Demon##25068 |q 11537/2 |goto Isle of Quel'Danas,48.5,43.7
...
ZygorGuidesViewer:RegisterInclude("Therazane_Dailies", [[
	...
	label "Reset"
		...
		accept Fear of Boring##27046 |goto Deepholm/0 56.1,14.4
		accept Motes##27047 |goto Deepholm/0 56.1,14.4
		accept Beneath the Surface##28488 |goto Deepholm/0 56.1,14.4
		|tip The quests that appear are random each day.
		|noquest
	step
		talk Terrath the Steady##43806
		accept The Restless Brood##28391 |goto Deepholm/0 56.6,14.1
		|noquest
		only if rep ('Therazane') >= Revered
	step
		talk Pyrite Stonetender##44945
		accept Lost In The Deeps##26710 |goto Deepholm/0 55.4,14.2
		|noquest
	step
		talk Gorsik the Tumultuous##43804
		|tip Walking around this area.
		accept Soft Rock##27049 |goto Deepholm/0 57.3,12.5
		accept Fungal Fury##27050 |goto Deepholm/0 57.3,12.5
	step
		talk Ruberick##44973
		accept Through Persistence##27051 |goto Deepholm/0 59.6,14.0
		accept Glop, Son of Glop##28390 |only if rep ('Therazane') >= Revered |goto Deepholm/0 59.6,14.0
		|noquest
	step
		use the Stonework Mallet##60266
		|tip It's a huge green crystal sitting on the ground.
		Strike the Pale Resonating Crystal |q 28391/1 |goto Deepholm/0 32.7,24.3
	...
	step
		...
		Defeat Aeosera |q 28391/2 |goto Deepholm/0 32.7,24.3
		only if rep ('Therazane') >= Revered
	step
		talk Terrath the Steady##43806
		turnin The Restless Brood##28391 |goto Deepholm/0 56.6,14.1
		only if rep ('Therazane') >= Revered
	...
	step
		...
		talk Ricket##44968
		|tip Inside the cave.
		accept Underground Economy##27048 |goto Deepholm/0 61.3,26.2
	...
	label "Collect_Painite_Shard"
		...
		collect 10 Painite Mote##60791 |q 27047/1 |goto Deepholm/0 63.6,23.9
		|only if haveq(27047) or completedq(27047)
	step
		talk Pebble##49956
		Tell him to follow you |q 26710 |future |goto Deepholm/0 63.1,20.8 |or
		|confirm |or
		|only if haveq(26710) or completedq(26710)
	step
		Follow this path |goto Deepholm/0 64.2,17.6 < 10 |only if walking
		talk Ricket##44968
		turnin Underground Economy##27048 |goto Deepholm/0 61.3,26.2
		|only if haveq(27048) or completedq(27048)
	step
		Leave the cave |goto Deepholm/0 58.3,25.6 < 10 |walk
		Wait in this spot until Pebble bobbles around appreciatively and then disappears into the distance
		Bring Pebble to safety |q 26710/1 |goto Deepholm/0 58.3,25.6
		|only if haveq(26710) or completedq(26710)
	stickystart "Collect_Bag_of_Verlok_Miracle_Grow"
	stickystart "Destroy_Freshly_Sprouted_Mushrooms"
	step
		kill 8 Fungal Behemoth##42475 |q 27049/1 |goto Deepholm/0 74.0,41.2
	step
	label "Collect_Bag_of_Verlok_Miracle_Grow"
		...
		collect Bag of Verlok Miracle-Grow##60767 |q 27051/1 |goto Deepholm/0 74.0,41.2
	step
	label "Destroy_Freshly_Sprouted_Mushrooms"
		...
		Destroy #10# Freshly Sprouted Mushrooms |q 27050/1 |goto Deepholm/0 74.0,41.2
	step
		Enter the cave |goto Deepholm/0 68.6,29.1 < 10 |walk
		talk Earthmender Norsala##43503
		Tell her you're ready when she is
		kill Fungalmancer Glop##43372 |q 28390/1 |goto Deepholm/0 69.8,31.9
	...
	step
		Follow the path up |goto Deepholm/0 70.2,33.8 < 10 |only if walking
		Leave the cave |goto Deepholm/0 68.6,29.1 < 10 |walk
		talk Felsen the Enduring##43805
		turnin Fear of Boring##27046 |goto Deepholm/0 Deepholm 56.1,14.4 |only if haveq(27046) or completedq(27046)
		turnin Motes##27047 |goto Deepholm/0 Deepholm 56.1,14.4 |only if haveq(27047) or completedq(27047)
		turnin Beneath the Surface##28488 |goto Deepholm/0 Deepholm 56.1,14.4 |only if haveq(28488) or completedq(28488)
	step
		talk Pyrite Stonetender##44945
		turnin Lost In The Deeps##26710 |goto Deepholm/0 55.4,14.2
		only if haveq(26710) or completedq(26710)
	step
		talk Gorsik the Tumultuous##43804
		|tip Walking around this area.
		turnin Soft Rock##27049 |goto Deepholm/0 57.3,12.5 |only if haveq(27049) or completedq(27049)
		turnin Fungal Fury##27050 |goto Deepholm/0 57.3,12.5 |only if haveq(27050) or completedq(27050)
	step
		talk Ruberick##44973
		turnin Through Persistence##27051 |goto Deepholm/0 59.6,14.0 |only if haveq(27051) or completedq(27051)
		turnin Glop, Son of Glop##28390 |goto Deepholm/0 59.6,14.0 |only if haveq(28390) or completedq(28390)
	step
