...
ZTA:RegisterBuild("DEATHKNIGHT","Leveling Blood","lvlblood",true,"Blood", [[
	Unholy Blight
	Anti-Magic Zone
	Asphyxiate
	Conversion
...
ZTA:RegisterBuild("DEATHKNIGHT","Leveling Frost","lvlfrost",true,"Frost", [[
	Unholy Blight
	Anti-Magic Zone
	Asphyxiate
	Death Pact
...
ZTA:RegisterBuild("DEATHKNIGHT","Leveling Unholy","lvlunholy",true,"Unholy", [[
	Unholy Blight
	Anti-Magic Zone
	Asphyxiate
	Death Siphon
...
ZTA:RegisterBuild("PRIEST","Leveling Shadow","lvlshadow",true,"Shadow", [[
	Void Tendrils
	Body and Soul
...
ZTA:RegisterBuild("PRIEST","Leveling Discipline","lvldiscipline",true,"Discipline", [[
	Void Tendrils
	Body and Soul
	Mindbender
	Angelic Bulwark
...
ZTA:RegisterBuild("PRIEST","Leveling Holy","lvlholy",true,"Holy", [[
	Void Tendrils
	Body and Soul
	Mindbender
	Angelic Bulwark
...
ZTA:RegisterBuild("MAGE","Leveling Fire","lvlfire",true,"Fire", [[
	Presence of Mind
	Ice Barrier
	Ice Ward
...
ZTA:RegisterBuild("MAGE","Leveling Frost","lvlfrost",true,"Frost", [[
	Ice Floes
	Ice Barrier
	Ring of Frost
	Cold Snap
...
ZTA:RegisterBuild("MAGE","Leveling Arcane","lvlarcane",true,"Arcane", [[
	Ice Floes
	Ice Barrier
	Ring of Frost
	Greater Invisibility
...
ZTA:RegisterBuild("WARRIOR","Leveling Arms","lvlarms",true,"Arms", [[
	Double Time
	Impending Victory
	Staggering Shout
	Dragon Roar
...
ZTA:RegisterBuild("WARRIOR","Leveling Fury","lvlfury",true,"Fury", [[
	Double Time
	Impending Victory
	Staggering Shout
	Dragon Roar
...
ZTA:RegisterBuild("WARRIOR","Leveling Protection","lvlprotection",true,"Protection", [[
	Double Time
	Impending Victory
	Staggering Shout
	Dragon Roar
...
ZTA:RegisterBuild("DRUID","Leveling Feral","lvlferal",true,"Feral", [[
	Displacer Beast
	Ysera's Gift
	Mass Entanglement
	Soul of the Forest
...
ZTA:RegisterBuild("DRUID","Leveling Guardian","lvlguardian",true,"Guardian", [[
	Wild Charge
	Ysera's Gift
	Typhoon
	Incarnation
...
ZTA:RegisterBuild("DRUID","Leveling Balance","lvlbalance",true,"Balance", [[
	Wild Charge
	Ysera's Gift
	Mass Entanglement
	Soul of the Forest
...
ZTA:RegisterBuild("DRUID","Leveling Restoration","lvlrestoration",true,"Restoration", [[
	Wild Charge
	Cenarion Ward
	Mass Entanglement
	Incarnation
...
ZTA:RegisterBuild("SHAMAN","Leveling Elemental","lvlelemental",true,"Elemental", [[
	Stone Bulwark Totem
	Earthgrab Totem
	Totemic Projection
...
ZTA:RegisterBuild("SHAMAN","Leveling Enhancement","lvlenhancement",true,"Enhancement", [[
	Astral Shift
	Frozen Power
	Totemic Projection
	Elemental Mastery
...
ZTA:RegisterBuild("SHAMAN","Leveling Restoration","lvlrestoration",true,"Restoration", [[
	Astral Shift
	Frozen Power
	Totemic Projection
	Ancestral Swiftness
...
ZTA:RegisterBuild("HUNTER","Leveling Beast Mastery","lvlmastery",true,"Beast Mastery", [[
...
ZTA:RegisterBuild("HUNTER","Leveling Marksmanship","lvlmarksmanship",true,"Marksmanship", [[
	Crouching Tiger, Hidden Chimera
	Intimidation
...
ZTA:RegisterBuild("HUNTER","Leveling Survival","lvlsurvival",true,"Survival", [[
	Crouching Tiger, Hidden Chimera
	Intimidation
	Aspect of the Iron Hawk
	Thrill of the Hunt
...
ZTA:RegisterBuild("MONK","Leveling Brewmaster","lvlbrewmaster",true,"Brewmaster", [[
	Tiger's Lust
	Chi Wave
	Ascension
	Leg Sweep
...
ZTA:RegisterBuild("MONK","Leveling Mistweaver","lvlmistweaver",true,"Mistweaver", [[
	Celerity
	Chi Wave
	Ascension
	Charging Ox Wave
...
ZTA:RegisterBuild("MONK","Leveling Windwalker","lvlwindwalker",true,"Windwalker", [[
	Momentum
	Chi Wave
	Ascension
	Leg Sweep
...
ZTA:RegisterBuild("WARLOCK","Leveling Demonology","lvldemonology",true,"Demonology", [[
	Soul Leech
	Shadowfury
	Sacrificial Pact
	Burning Rush
...
ZTA:RegisterBuild("WARLOCK","Leveling Destruction","lvldestruction",true,"Destruction", [[
	Soul Leech
	Shadowfury
	Dark Bargain
	Burning Rush
...
ZTA:RegisterBuild("WARLOCK","Leveling Affliction","lvlaffliction",true,"Affliction", [[
	Harvest Life
	Shadowfury
	Dark Bargain
	Burning Rush
...
ZTA:RegisterBuild("ROGUE","Leveling Assassination","lvlassassination",true,"Assassination", [[
	Subterfuge
	Nerve Strike
	Leeching Poison
	Burst of Speed
...
ZTA:RegisterBuild("ROGUE","Leveling Combat","lvlcombat",true,"Combat", [[
	Subterfuge
	Combat Readiness
	Leeching Poison
	Shadowstep
...
ZTA:RegisterBuild("ROGUE","Leveling Subtlety","lvlsubtlety",true,"Subtlety", [[
	Nightstalker
	Combat Readiness
	Leeching Poison
	Shadowstep
...
ZTA:RegisterBuild("PALADIN","Leveling Holy","lvlholy",true,"Holy", [[
	Pursuit of Justice
	Repentance
	Eternal Flame
	Clemency
...
ZTA:RegisterBuild("PALADIN","Leveling Protection","lvlprotection",true,"Protection", [[
	Long Arm of the Law
	Fist of Justice
	Eternal Flame
	Hand of Purity
...
ZTA:RegisterBuild("PALADIN","Leveling Retribution","lvlretribution",true,"Retribution", [[
	Speed of Light
	Fist of Justice
	Selfless Healer
	Unbreakable Spirit
