...
PlayerHPMPPct.HP:SetFont(GameFontNormal:GetFont(), 12, "THICKOUTLINE");
...
PlayerHPMPPct.MP:SetFont(GameFontNormal:GetFont(), 12, "THICKOUTLINE");
...
PlayerHPMPPct.Pct:SetFont(GameFontNormal:GetFont(), 12, "THICKOUTLINE");
...
function UnitFramesPlus_PlayerExtraTextFontSize()
    UFP_PlayerHPMPPctHP:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["player"]["fontsize"], "THICKOUTLINE");
    UFP_PlayerHPMPPctMP:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["player"]["fontsize"], "THICKOUTLINE");
    UFP_PlayerHPMPPctPct:SetFont(GameFontNormal:GetFont(), UnitFramesPlusDB["player"]["fontsize"], "THICKOUTLINE");

    if not IsAddOnLoaded("EasyFrames") then
		PlayerName:SetFont(GameFontNormalSmall:GetFont(), UnitFramesPlusDB["player"]["fontsize"]);
		PlayerFrameHealthBarText:SetFont(TextStatusBarText:GetFont(), UnitFramesPlusDB["player"]["fontsize"], "THICKOUTLINE");
		PlayerFrameHealthBarTextLeft:SetFont(TextStatusBarText:GetFont(), UnitFramesPlusDB["player"]["fontsize"], "THICKOUTLINE");
		PlayerFrameHealthBarTextRight:SetFont(TextStatusBarText:GetFont(), UnitFramesPlusDB["player"]["fontsize"], "THICKOUTLINE");
		PlayerFrameManaBarText:SetFont(TextStatusBarText:GetFont(), UnitFramesPlusDB["player"]["fontsize"], "THICKOUTLINE");
		PlayerFrameManaBarTextLeft:SetFont(TextStatusBarText:GetFont(), UnitFramesPlusDB["player"]["fontsize"], "THICKOUTLINE");
		PlayerFrameManaBarTextRight:SetFont(TextStatusBarText:GetFont(), UnitFramesPlusDB["player"]["fontsize"], "THICKOUTLINE");
	end
end
