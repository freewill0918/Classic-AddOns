...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20241120155157")
...
DBM.DisplayVersion = "11.0.31"--Core version
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20241120155157" to be auto set by packager
