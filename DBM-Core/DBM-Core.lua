...
DBM.Revision = parseCurseDate("20260316213103")
DBM.TaintedByTests = false -- Tests may mess with some internal state, you probably don't want to rely on DBM for an important boss fight after running it in test mode

private.fakeBWVersion, private.fakeBWHash = 407, "a0f5bf5"--407.0

-- The string that is shown as version
DBM.DisplayVersion = "12.0.31"--Core version
DBM.classicSubVersion = 0
DBM.dungeonSubVersion = 0
DBM.ReleaseRevision = releaseDate(2026, 3, 16) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
...
---@param revision number|string Either a number in the format "202101010000" (year, month, day, hour, minute) or string "20260316213103" to be auto set by packager
