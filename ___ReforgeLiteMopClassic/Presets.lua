...
local ReforgeLiteMopClassic = addonTable.ReforgeLiteMopClassic
...
local MASTERY_BUFFS = {
  ...
  128997, -- Espírito Beast Blessing
  19740,  -- Blessing of Might
  116956, -- Grace of Air
}

function ReforgeLiteMopClassic:PlayerHasSpellHasteBuff()
...
function ReforgeLiteMopClassic:PlayerHasMeleeHasteBuff()
...
function ReforgeLiteMopClassic:PlayerHasMasteryBuff()
...
function ReforgeLiteMopClassic:RatingPerPoint (stat, level)
...
function ReforgeLiteMopClassic:GetMeleeHitBonus ()
  return GetHitModifier () or 0
end
function ReforgeLiteMopClassic:GetSpellHitBonus ()
  return GetSpellHitModifier () or 0
end
function ReforgeLiteMopClassic:GetExpertiseBonus()
...
function ReforgeLiteMopClassic:GetNonSpellHasteBonus(hasteFunc, ratingBonusId)
...
function ReforgeLiteMopClassic:GetMeleeHasteBonus()
  return self:GetNonSpellHasteBonus(GetMeleeHaste, CR_HASTE_MELEE)
end
function ReforgeLiteMopClassic:GetRangedHasteBonus()
  return self:GetNonSpellHasteBonus(GetRangedHaste, CR_HASTE_RANGED)
end
function ReforgeLiteMopClassic:GetSpellHasteBonus()
...
function ReforgeLiteMopClassic:GetHasteBonuses()
  return self:GetMeleeHasteBonus(), self:GetRangedHasteBonus(), self:GetSpellHasteBonus()
end
function ReforgeLiteMopClassic:CalcHasteWithBonus(haste, hasteBonus)
  return ((hasteBonus - 1) * 100) + haste * hasteBonus
end
function ReforgeLiteMopClassic:CalcHasteWithBonuses(haste)
...
function ReforgeLiteMopClassic:GetNeededMeleeHit ()
  return max(0, 3 + 1.5 * self.pdb.targetLevel)
end
function ReforgeLiteMopClassic:GetNeededSpellHit ()
...
function ReforgeLiteMopClassic:GetNeededExpertiseSoft()
  return max(0, 3 + 1.5 * self.pdb.targetLevel)
end

function ReforgeLiteMopClassic:GetNeededExpertiseHard()
...
ReforgeLiteMopClassic.capPresets = {
  {
  ...
  },
  {
    ...
    name = L[L["Melee hit cap"]],
    getter = function ()
      return ReforgeLiteMopClassic:RatingPerPoint(StatHit) * (ReforgeLiteMopClassic:GetNeededMeleeHit() - ReforgeLiteMopClassic:GetMeleeHitBonus())
    end,
    category = StatHit
  },
  {
    ...
    getter = function ()
      return ReforgeLiteMopClassic:RatingPerPoint (addonTable.statIds.SPELLHIT) * (ReforgeLiteMopClassic:GetNeededSpellHit () - ReforgeLiteMopClassic:GetSpellHitBonus ())
    end,
    category = StatHit
  },
  {
    ...
    getter = function ()
      return ReforgeLiteMopClassic:RatingPerPoint(StatHit) * (ReforgeLiteMopClassic:GetNeededMeleeHit() + 19 - ReforgeLiteMopClassic:GetMeleeHitBonus())
    end,
    category = StatHit
  },
  {
    value = CAPS.ExpSoftCap,
    name = L[L["Expertise soft cap"]],
    getter = function ()
      return ReforgeLiteMopClassic:RatingPerPoint (StatExp) * (ReforgeLiteMopClassic:GetNeededExpertiseSoft() - ReforgeLiteMopClassic:GetExpertiseBonus())
    end,
    category = StatExp
  },
  {
    value = CAPS.ExpHardCap,
    name = L["Aptidão hard cap"],
    getter = function ()
      return ReforgeLiteMopClassic:RatingPerPoint (StatExp) * (ReforgeLiteMopClassic:GetNeededExpertiseHard() - ReforgeLiteMopClassic:GetExpertiseBonus())
    end,
    category = StatExp
  },
}
...
local function GetSpellHasteRequired(percentNeeded)
  return function()
    local hasteMod = ReforgeLiteMopClassic:GetSpellHasteBonus()
    return ceil((percentNeeded - (hasteMod - 1) * 100) * ReforgeLiteMopClassic:RatingPerPoint(addonTable.statIds.HASTE) / hasteMod)
  end
end
...
do
  ...
  if addonTable.playerClass == "DRUID" then
    tinsert(ReforgeLiteMopClassic.capPresets, {
...
function ReforgeLiteMopClassic:InitClassPresets()
  local specs = {
...
function ReforgeLiteMopClassic:InitCustomPresets()
  local customPresets = {}
...
function ReforgeLiteMopClassic:InitPresets()
    ...
    self.presets["Pawn"] = function ()
      ...
      for k, v in pairs (PawnCommon.Scales) do
        if v.ClassID == addonTable.playerClassID then
          ...
          preset.weights[addonTable.statIds.SPIRIT] = raw[L["Spirit"]] or 0
  ...
  self.presetMenu = LibDD:Create_UIDropDownMenu("ReforgeLiteMopClassicPresetMenu", self)
  ...
  --[===[@debug@
  self.exportPresetMenu = LibDD:Create_UIDropDownMenu("ReforgeLiteMopClassicExportPresetMenu", self)
  ...
  self.presetDelMenu = LibDD:Create_UIDropDownMenu("ReforgeLiteMopClassicPresetDelMenu", self)
