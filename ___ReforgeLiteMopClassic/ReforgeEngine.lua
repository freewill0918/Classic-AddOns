...
function ReforgeLiteMopClassic:GetStatMultipliers()
  local result = {}
...
function ReforgeLiteMopClassic:GetConversion()
...
function ReforgeLiteMopClassic:UpdateMethodStats (method)
...
function ReforgeLiteMopClassic:FinalizeReforge (data)
...
function ReforgeLiteMopClassic:ResetMethod ()
  local method = { items = {} }
...
function ReforgeLiteMopClassic:CapAllows (cap, value)
...
function ReforgeLiteMopClassic:IsItemLocked (slot)
...
function ReforgeLiteMopClassic:MakeReforgeOption(item, data, src, dst)
...
function ReforgeLiteMopClassic:GetItemReforgeOptions (item, data, slot)
...
function ReforgeLiteMopClassic:InitializeMethod()
  local method = { items = {} }
  local orgitems = {}
  local statsSum = 0
  for k, v in ipairs(self.itemData) do
...
function ReforgeLiteMopClassic:InitReforgeClassic()
...
function ReforgeLiteMopClassic:ComputeReforgeCore (data, reforgeOptions)
  local scores, codes = {}, {}
...
function ReforgeLiteMopClassic:ChooseReforgeClassic (data, reforgeOptions, scores, codes)
...
function ReforgeLiteMopClassic:ComputeReforge()
...
function ReforgeLiteMopClassic:ResumeCompute()
...
function ReforgeLiteMopClassic:ResumeComputeNextFrame()
  RunNextFrame(function() self:ResumeCompute() end)
end

function ReforgeLiteMopClassic:RunYieldCheck(maxLoops)
...
function ReforgeLiteMopClassic:StartCompute()
...
function ReforgeLiteMopClassic:EndCompute()
